...
export declare const userEvent: {
    readonly setup: typeof import("@testing-library/user-event/dist/types/setup/setup").setupMain;
    readonly clear: typeof import("@testing-library/user-event/dist/types/setup/directApi").clear;
    readonly click: typeof import("@testing-library/user-event/dist/types/setup/directApi").click;
    readonly copy: typeof import("@testing-library/user-event/dist/types/setup/directApi").copy;
    readonly cut: typeof import("@testing-library/user-event/dist/types/setup/directApi").cut;
    readonly dblClick: typeof import("@testing-library/user-event/dist/types/setup/directApi").dblClick;
    readonly deselectOptions: typeof import("@testing-library/user-event/dist/types/setup/directApi").deselectOptions;
    readonly hover: typeof import("@testing-library/user-event/dist/types/setup/directApi").hover;
    readonly keyboard: typeof import("@testing-library/user-event/dist/types/setup/directApi").keyboard;
    readonly pointer: typeof import("@testing-library/user-event/dist/types/setup/directApi").pointer;
    readonly paste: typeof import("@testing-library/user-event/dist/types/setup/directApi").paste;
    readonly selectOptions: typeof import("@testing-library/user-event/dist/types/setup/directApi").selectOptions;
    readonly tripleClick: typeof import("@testing-library/user-event/dist/types/setup/directApi").tripleClick;
    readonly type: typeof import("@testing-library/user-event/dist/types/setup/directApi").type;
    readonly unhover: typeof import("@testing-library/user-event/dist/types/setup/directApi").unhover;
    readonly upload: typeof import("@testing-library/user-event/dist/types/setup/directApi").upload;
    readonly tab: typeof import("@testing-library/user-event/dist/types/setup/directApi").tab;
};
